          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-sm bg-gradient-to-br from-[#d4c4ed] to-[#b99ee0] rounded-3xl p-6 sm:p-8 shadow-xl border border-purple-200/50 overflow-hidden text-purple-950">
              ...
              <div className="relative z-10 space-y-6">
                ...
                {/* QR Code Scan Simulator Box (Linked to Google Play & set to black) */}
                {/* QR Code Scan Simulator Box (Linked to Google Play) */}
                <a
                  href="https://play.google.com/store/apps/details?id=com.padimanroute.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white rounded-2xl p-5 text-center shadow-sm flex flex-col items-center space-y-3 block hover:opacity-95 transition"
                >
                  <div className="w-28 h-28 bg-white rounded-xl p-1 border border-purple-100 flex items-center justify-center overflow-hidden">
                    {/* Real QR Code that opens Play Store when scanned */}
                    <img
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(
                        "https://play.google.com/store/apps/details?id=com.padimanroute.app"
                      )}&color=000000&bgcolor=ffffff&margin=1`}
                      alt="Scan to download PadimanRoute on Google Play"
